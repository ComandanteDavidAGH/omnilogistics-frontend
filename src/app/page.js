// URL de Render forzada directamente (ignora la configuración de Vercel)
  ...
  try {
    ...
    throw new ApiError(
      timedOut
        ...
        : 'No se pudo conectar con el servidor backend. Revisa que esté activo.',
...
export const api = {
  // Ahora el login consultará directamente la raíz de salud del servidor
  me: async (apiKey) => {
